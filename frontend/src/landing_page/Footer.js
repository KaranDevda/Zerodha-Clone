...
function Footer() {
    return ( 
        <footer style={{backgroundColor: "rgb(240, 240, 240)"}} r>
        <div className="container border-top mt-5">
            <div className="row mt-5">
                <div className='col'>
                    <img src='/images/logo.svg' style={{width:"45%"}}/>
                    <p>
            ...
            <div className='mt-5 text-small text-muted' style={{fontSize: "14px"}}>
                ...
                <p>Smart Online Dispute Resolution | Grievances Redressal Mechanism <br/></p>
                ...
                <p>India's largest broker based on networth as per NSE. NSE broker factsheet <br/></p>
